...
export default function TentangKamiPage() {
  const districts = [
    ...
    {
      name: "Kec. Taktakan",
      desc: "Sentra agrowisata, madu akasia & perkebunan herbal",
    },
      ...
      <SectionContainer aria-labelledby="vision-heading" className="py-0">
        <div className="items-center gap-8 grid grid-cols-1 md:grid-cols-2">
          ...
          <aside
            ...
            className="space-y-4 bg-white dark:bg-surface-darkCard shadow-card-hover p-8 border border-slate-200/80 dark:border-slate-800 rounded-3xl"
          >
            ...
            <article className="flex items-start gap-4 bg-slate-50 dark:bg-slate-900/60 p-4 rounded-2xl">
              <div className="flex justify-center items-center bg-whatsapp-500 rounded-xl w-10 h-10 text-white shrink-0">
                <MessageCircle
            ...
            <article className="flex items-start gap-4 bg-slate-50 dark:bg-slate-900/60 p-4 rounded-2xl">
              <div className="flex justify-center items-center bg-brand-800 rounded-xl w-10 h-10 text-white shrink-0">
